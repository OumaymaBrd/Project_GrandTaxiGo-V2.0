...
<body>
    ...
    <div class="w-full">
        ...
        <div class="flex items-center gap-2">
          ...
          {{-- voila input de l'envoie de Message : sur cette partie  --}}
          <input class="grow shrink basis-0 text-black text-xs font-medium leading-4 focus:outline-none" placeholder="Type here..." id="nickname">
        </div>
        <div class="flex items-center gap-2">
          ...
          <button class="items-center flex px-3 py-2 bg-indigo-600 rounded-full shadow " id="submitButton">
        ...
        <div class="w-full pl-3 pr-1 py-1 rounded-3xl border border-gray-200 items-center gap-2 inline-flex justify-between">
            <div class="flex items-center gap-2">
              ...
              {{-- voila input de l'envoie de Message : sur cette partie  --}}
              <input class="grow shrink basis-0 text-black text-xs font-medium leading-4 focus:outline-none" placeholder="Type here..." id="message">
            </div>
            <div class="flex items-center gap-2">
              <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                <g id="Attach 01">
